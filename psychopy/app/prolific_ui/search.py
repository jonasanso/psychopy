...
class SearchFrame(wx.Dialog):
    ...
    def onSearch(self, evt=None):
        ...
        if opts['inclGroup'] and (newSearch or self.lastSearchGp is None):
            ...
            print("ERROR: During Prolific search we found opts['inclGroup']={}, newSearch={}"
        ...
        if opts['inclPublic'] and (newSearch or self.lastSearchPub is None):
            ...
            print("ERROR: During Prolific search we found opts['inclPublic']={}, newSearch={}"
        ...
        projs = [prolific.ProlificProject(proj) for proj in projs if proj.id]
    ...
    def onLoginClick(self, event):
        user = logInProlific(parent=self.parent)
...
class ProjectListCtrl(wx.ListCtrl, listmixin.ListCtrlAutoWidthMixin):
    ...
    def setContents(self, projects):
        self.DeleteAllItems()
        # first time around we have a list of ProlificProjects
        if projects and isinstance(projects[0], prolific.ProlificProject):
            self.projList = []
